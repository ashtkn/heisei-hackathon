  ...
  computed: {
    ...
    items: function () {
      ...
      for (var i = 0; i < this.numbers.length; i++) {
        ...
        var fill = this.hsvToRgb(i * 360 / this.numbers.length, 1, v)
